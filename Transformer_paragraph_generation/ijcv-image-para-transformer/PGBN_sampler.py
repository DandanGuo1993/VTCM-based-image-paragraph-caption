...
Multi_lib = ll("F:\image-para\exp\image_para_cap_gbn_3layers\libMulti_Sample.dll")
...
Crt_Multi_lib = ll("F:/image-para/exp/image_para_cap_gbn_3layers/libCrt_Multi_Sample.dll")
...
Crt_lib = ll("F:/image-para/exp/image_para_cap_gbn_3layers/libCrt_Sample.dll")
