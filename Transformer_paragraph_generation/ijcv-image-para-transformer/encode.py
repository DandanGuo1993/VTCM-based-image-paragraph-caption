...
from src.load_dataset import load_dataset as load_dataset
...
parser.add_argument('--in_text', metavar='PATH', type=str, default='G:/learning resource/PGBN/topic and language model/Data/imdb/train.txt', help='Input file, directory, or glob pattern (utf-8 text).')
parser.add_argument('--out_npz', metavar='OUT.npz', type=str, default='G:/learning resource/PGBN/topic and language model/Data/imdb/train.npz', help='Output file path')
