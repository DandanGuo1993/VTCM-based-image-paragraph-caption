...
def parse_opt():
    ...
    parser.add_argument('--start_from', type=str, default = None) #'./log_xe_GBN3' './log_xe_GBN3_bow'

    parser.add_argument('--checkpoint_path', type=str, default='log_xe_GBN3_bow_3/')

    parser.add_argument('--best_model', type=str, default=None) #'i39000-score0.0937''i37500-score0.0952'

    parser.add_argument('--best_model_number', type=str, default=37500)#'12000'
    ...
    parser.add_argument('--learning_rate', type=float, default=5e-4,
                    help='learning rate')
    # Data input settings
    parser.add_argument('--input_json', type=str, default='F:/image-para/exp/data/paratalk_new.json',
                    help='path to the json file containing additional info and vocab')
    parser.add_argument('--input_label_h5', type=str, default='F:/image-para/exp/data/paratalk_label_new_label.h5',
                    help='path to the h5file containing the preprocessed dataset index')

    parser.add_argument('--input_fc_dir', type=str, default='F:\image-para\exp\data/densecaption_fc',
                    help='path to the directory containing the preprocessed fc feats')
    parser.add_argument('--input_att_dir', type=str, default='F:\image-para\exp\data/densecaption_att',
                    help='path to the directory containing the preprocessed att feats')
    parser.add_argument('--input_box_dir', type=str, default='F:\image-para\exp\data/densecaption_box',
    ...
    parser.add_argument('--S_max', type=int, default=1,
                    help='number of layers in the RNN')
    parser.add_argument('--N_max', type=int, default=180,
                    help='number of layers in the RNN')
    ...
    parser.add_argument('--fc_feat_size', type=int, default=4096, #4096,
                    help='2048 for resnet, 4096 for vgg')
    parser.add_argument('--att_feat_size', type=int, default=4096, #4096,
                    help='2048 for resnet, 4096 for vgg')
    # parser.add_argument('--fc_feat_size', type=int, default=4096,
    #                 help='2048 for resnet, 4096 for vgg')
    # parser.add_argument('--att_feat_size', type=int, default=4096,
